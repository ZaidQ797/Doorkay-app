      ...
      <ScrollView keyboardShouldPersistTaps='always'>
        <View style={styles.container}>
          ...
          <View style={styles.block_one} >
            ...
            <View>
              <Text style={styles.forgot_your_password} >Forgot Your Password</Text>
            </View>
            <View style={styles.description_content} >
              <Text style={styles.description} >Enter your email below to receive the instructions to reset your password</Text>
            </View>
          </View>
