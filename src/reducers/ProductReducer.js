...
const ProductReducer = (state = { service_id:undefined, cart_count:undefined, cart_items:[], isLoding: false, error: undefined, data:undefined, message:undefined, status:undefined }, action) => {
    switch (action.type) {
        ...
        case Actions.CHANGE_SERVICE_ID:
            return Object.assign({}, state, {
